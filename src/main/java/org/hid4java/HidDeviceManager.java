...
class HidDeviceManager
{
     ...
     */
    private final Map<String, HidDeviceInfo> attachedDevices = Collections
            .synchronizedMap(new HashMap<String, HidDeviceInfo>());
    ...
    public HidDevice open(HidDeviceInfo info)
    {
        ...
        if (deviceStructure != null)
        {
            return new HidDevice(this, deviceStructure, info.getVendorId(), info.getProductId(), info.getSerialNumber()
                    .toString());
        }
        return null;
